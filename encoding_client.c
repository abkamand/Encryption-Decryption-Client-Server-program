...
int main(int argc, char *argv[]) {
  ...
  // error check if len_plain > len_key, if so output error and exit with value 1                                               
  ...
  //error check if plaintext has any bad characters, if so output error and exit with value 1
  for (int i = 0; i < len_plain; i++)
  {
    ...
    if ((plaintext[i] != ' ') && (plaintext[i] != '\n'))
    {
      if ((plaintext[i] < 65) || (plaintext[i] > 90))
      {
        ...
        //printf("Failed ascii value: %i\n", plaintext[i]);

        fprintf(stderr, "ERROR: Bad characters in text file.\n");
        exit(1);
      }
    }
  }
  ...
  */                                                                                                                      
  ...
  //**********************************************************
  //receive encoded_text from server
  if (receiveall(socketFD, encoded_text, len_plain) == -1)
  {
